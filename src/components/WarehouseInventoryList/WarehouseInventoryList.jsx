...
const WarehouseInventoryList = ({ warehouseInv }) => {
  return (
    <section className="wh-inv">
      ...
      <ul className="wh-inv__list">
        {warehouseInv.map((inventory) => (
          <li className="wh-inv__item" key={inventory.id}>
            <div className="wh-inv__info-group">
              ...
              >
                ...
                <p className="wh-inv__info wh-inv__info--status">
                  {inventory.status}
                </p>
              </div>
              <div className="wh-inv__info-item" id="category">
                <p className="wh-inv__sub-title">CATEGORY</p>
                <p className="wh-inv__info wh-inv__info--name">
                  {inventory.category}
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="wh-inv__info">{inventory.quantity}</p>
              </div>
              <div
